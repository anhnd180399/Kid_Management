    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              SvgPicture.asset('assets/images/location-tracking/bg_location.svg'),
              SizedBox(height: 20.0,),
              Row(
                children: [
                  !_searchBarIsShow ? Text(
                    'LOCATION HISTORY',
                    style:
                  ...
                  Visibility(child: Spacer(), visible: !_searchBarIsShow,),
                  IconButton(
                      icon: Icon(
                        Icons.search,
                        color: AppColor.mainColor,
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  color: Colors.white,
                  child: Text('CLEAR HISTORY', style: TextStyle(color: Colors.redAccent),),
                ),
              )
            ],
          ),
